...
class CLUBSample_reshape(nn.Module):  # Sampled version of the CLUB estimator
    """
    x_samples: samples from X and Y, having shape (bs, T, x_dim)
    y_samples: samples from X and Y, having shape (bs, T, y_dim)
    """
    def __init__(self, x_dim, y_dim, hidden_size):
...
class CLUBSample_group(nn.Module):  # Sampled version of the CLUB estimator
    """
    x_samples: samples from X and Y, having shape (bs, x_dim)
    y_samples: samples from X and Y, having shape (bs, T, y_dim)
    """
    def __init__(self, x_dim, y_dim, hidden_size):
